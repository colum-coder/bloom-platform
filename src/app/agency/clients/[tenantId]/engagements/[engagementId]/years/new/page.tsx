  ...
  return (
    <div className="px-6 sm:px-8 py-8 max-w-3xl mx-auto">
      ...
      <nav className="flex items-center gap-1.5 text-sm text-gray-400 mb-6 flex-wrap">
        ...
        <span>/</span>
        <span className="text-gray-700 font-medium">Add Claim Year</span>
      </nav>

      <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
        <h1 className="text-lg font-semibold text-gray-900 mb-1">Add SR&amp;ED Claim Year</h1>
        <p className="text-sm text-gray-400 mb-6">
          A claim year represents a specific fiscal year being prepared for SR&amp;ED.
          Context sources, AI runs, and proposals are all scoped to this year.
        </p>
        <FiscalYearForm
