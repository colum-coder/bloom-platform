        ...
        <div className="flex items-center justify-between gap-4 mb-3 flex-wrap">
          <div>
            ...
            <p className="text-xs text-gray-400 mt-0.5">
              Each claim year has its own documents, context sources, and Project Discovery runs.
            </p>
          </div>
          <Link
                ...
                >
                  ...
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    <Link
                      ...
                      className="inline-flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-xs font-medium border border-gray-200 text-gray-600 bg-white hover:border-blue-300 hover:text-blue-700 transition-colors"
                    >
                      <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
